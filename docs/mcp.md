...
Graphs generated before `0.4.0-alpha.4`, non-web projects, unsupported routing patterns, or stale graph files may have no endpoint nodes. In those cases, entrypoint tools return a graph-specific limitation instead of inventing HTTP routes:
