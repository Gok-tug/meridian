...
- `agent-summary` text sections including compact diagnostic groups, JSON parseability, and missing graph errors.
...
- `get_diagnostics`,
- `get_agent_summary`,
- search response summaries for relation-heavy results,
- `shortest_path`,
- `explain_path`,
